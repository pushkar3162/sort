...
const filesFoldersDate = [
  ...
  const [folders, setFolders] = useState(filesFoldersDate);
    ...
    <DndProvider backend={HTML5Backend}>
      <div className="file-explorer">
        ...
        <div className="toolbar">
          ...
          />
          <button className="btn" onClick={createFolder}><FaFolderPlus /> New Folder</button>
          <button className="btn" onClick={() => setIsDropdownOpen(!isDropdownOpen)}>
            <FaSort /> Sort By {sortBy && `(${sortBy})`}
          </button>
          <button className="btn" onClick={fetchFolders}><FaSyncAlt /> Refresh</button>
